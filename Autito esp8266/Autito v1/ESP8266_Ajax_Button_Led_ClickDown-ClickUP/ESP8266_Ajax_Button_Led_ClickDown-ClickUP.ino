...
<script>
   function btnClick(id_Button){
      var btnClick = document.getElementById(id_Button);
      var comando = '';
      ...
      btnClick.onmousedown = function() {
        ...
        ajaxLoad(comando);
        //btnClick.value='Avanzando';
        btnClick.style.backgroundColor = '#4CAF50';
      };
      ...
      btnClick.onmouseup = function() {
        ...
        //btnClick.value='Avanzar';
        btnClick.style.backgroundColor = '#e7e7e7';
      };
   }
...
String html_2 = R"=====(  
  <input type="button" id="btn_Avanzar"     onclick='btnClick("btn_Avanzar")'     value="Avanzar"     class="btn"   /> 
  <input type="button" id="btn_Izquierda"   onclick='btnClick("btn_Izquierda")'   value="Izquierda"   class="btn"   />
  <input type="button" id="btn_Derecha"     onclick='btnClick("btn_Derecha")'     value="Derecha"     class="btn"   />
  <input type="button" id="btn_Retroceder"  onclick='btnClick("btn_Retroceder")'  value="Retroceder"  class="btn"   />
)=====";
